...
register_model_group(
    models={
        "Kimi-Audio-7B": {
            DownloadSource.DEFAULT: "/mnt/workspace/hyq/code/come_in/asr/xjz-assignment/kimi-audio/Kimi-Audio/output/pretrained_hf",
        },
        "Kimi-Audio-7B-Finetuned": {
            DownloadSource.DEFAULT: "/mnt/workspace/hyq/code/come_in/asr/xjz-assignment/kimi-audio/Kimi-Audio/output/finetuned_hf_for_inference",
        },
    },
    template="default",  # 或根据Kimi-Audio的模板调整
    multimodal=True,  # Kimi-Audio是多模态模型（音频+文本）
)
